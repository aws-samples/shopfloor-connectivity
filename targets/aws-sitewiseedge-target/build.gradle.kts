...
dependencies {
    ...
    implementation("software.amazon.awssdk:iotsitewise:$awsSdkVersion")
}

application {
    mainClass.set("com.amazonaws.sfc.sitewiseedge.SiteWiseEdgeTargetService")
