...
class Sawtooth(val minValue: Double, val maxValue: Double, val dataType: DataType, cycleLength: Long? = null, val arraySize: Int) : Simulation {
    ...
    val currentValue: Double
        get() {
            ...
            val currentValue = range * inCycle + minValue
    ...
    companion object {
        ...
        fun fromJson(o: JsonObject): Simulation {
            ...
            val length = maxOf(1L, o.getLong(CONFIG_CYCLE_LENGTH, null) ?: DEFAULT_CYCLE_LENGTH)
            ...
            val s = Sawtooth(min, max, dataType, length, arraySize)
            return s
        }
