 ...
 * @constructor
 */
class LessValueFilter(private val value: Any) : Filter {
    ...
    companion object {
        ...
        private fun create(configuration: FilterConfiguration): Filter {
            return LessValueFilter(configuration.conditionValue!!)
        }
        ...
        fun register(filterBuilder: FilterBuilder) {
            filterBuilder.registerOperator(OPERATOR_LT, OPERATOR_LT_STR) { _: FilterBuilder, c -> create(c) }
        }
    }
