    ...
    companion object {
        ...
        init {
            listOf(
                ...
                AtIndex::class,
                BoolToNumber::class,
                BytesToDoubleBE::class,
                BytesToDoubleLE::class,
                BytesToInt16::class,
                BytesToFloatBE::class,
                BytesToFloatLE::class,
                Ceil::class,
                Celsius::class,
                Chunked::class,
                Cos::class,
                ...
                Equals::class,
                Exp::class,
                EpocSecondsToTimestamp::class,
                EpocMilliSecondsToTimestamp::class,
                Fahrenheit::class,
                Flatten::class,
                Floor::class,
                Int16ToBytes::class,
                NumbersToFloatBE::class,
                NumbersToFloatLE::class,
                Int16sToInt32::class,
                Int32ToInt16s::class,
                IsoDateTimeStrToEpocSeconds::class,
                IsoDateTimeStrToEpocMilliSeconds::class,
                IsoTimeStrToMilliSeconds::class,
                IsoTimeStrToNanoSeconds::class,
                IsoTimeStrToSeconds::class,
                TimestampToEpocMilliSeconds::class,
                TimestampToEpocSeconds::class,
                Ln::class,
                Log2::class,
                Log10::class,
                LowerCase::class,
