...
@ConfigurationClass
@TransformerOperator(["Minus", "-"])
class Minus(operand: Number?) : TransformationImpl<Number>(operand) {
    @TransformerMethod
    ...
    companion object {
        fun fromJson(o: JsonObject): TransformationOperator = TransformationOperatorNumericOperand.fromJson<Minus>(o)
        fun create(operand: Number) = Minus(operand)
    }
