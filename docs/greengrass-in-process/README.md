...
**The setup will configure all modules to be started in SFC's [`in-process mode`](../../docs#in-process-and-ipc-deployment-models)**. That means that all SFC modules run inside the sfc-main process on a single host.
