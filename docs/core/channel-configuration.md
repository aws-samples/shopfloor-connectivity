...
The value of this setting overrules the setting of the Decompose setting at source level.
<td>Boolean</td>
<td>Default is false
...
The value of this setting overrules the setting of the Spread setting at source level.</td>
<td>Boolean</td>
<td>Default is false
