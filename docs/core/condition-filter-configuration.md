...
<thead>
<tr class="header">
<th colspan="4">Configuration for value filter that let only pass values if they match the condition filter expression. When log level is trace then there will be log entries that show the filter expression how it is interpreted by SFC.</th>
</tr>
</thead>
<tbody>
<tr class="odd">
