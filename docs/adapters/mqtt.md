...
<tr class="even">
<td>Channels</td>
<td><p>The channels configuration for an MQTT source holds configuration data to read values from topics on the source MQTT broker.</p>
...
<td>Map[String,<a href="#mqttchannelconfiguration">MqttChannelConfiguration</a>]</td>
<td>At least 1 channel must be configured.</td>
</tr>

<tr class="odd">
<td>AdapterBroker</td>
<td>Broker Identifier for the MQTT server to read from. This referenced server must be present in the Brokers section of the adapter referred to by the ProtocolAdapter attribute of the source.</td>
<td>String</td>
<td>Must be an identifier of a broker in the Brokers section of the MQTT adapter used by the source.</td>
</tr>
...
The MqttChannelConfiguration extends the common Channel configuration with MQTT specific channel configuration data
...
The mapping of topic names of received data updates to data value names
...
The MqttAdapterConfiguration extends the common adapter configuration with MQTT specific adapter configuration settings. The AdapterType to use for this adapter is "MQTT"
